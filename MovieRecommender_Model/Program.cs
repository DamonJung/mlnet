        ...
        static void Main(string[] args)
        {
            ...
            var reader = ctx.Data.TextReader(new TextLoader.Arguments()
            {
                ...
                Column = new[]
                {
                    ...
                    // This weight is a total watch count of the movie. I added some random values from 1 to 10 into the original dataset.
                    // I want FFM consider this values and give high score accordingly if the count is higher
                    new TextLoader.Column("Weight", DataKind.R4, 1, 1),
            ...
            //                }
            //            );
            //Console.WriteLine($"UserId 6 and MovieId 10 -> {movieratingprediction.predictedLabel} :::: {movieratingprediction.Score}");
            ...
            while(keepGoing)
            {
                ...
                Console.WriteLine("");
                Console.WriteLine($"UserId {userId} and MovieId {movieId} -> {movieratingprediction.predictedLabel} :::: {movieratingprediction.Score}");
            }
